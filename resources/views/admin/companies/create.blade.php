...
<div class="bg-white p-6 rounded shadow-lg">
    <h1 class="text-3xl font-bold mb-4 text-center">Thêm Mới Công Ty</h1>
    ...
    <form action="{{ route('admin.companies.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="company_name" id="company_name" value="{{ old('company_name') }}" class="border p-2 w-full" required>
            @error('company_name')
        ...
        <div class="mb-4">
            ...
            <textarea name="company_info" id="company_info" rows="5" class="border p-2 w-full">{{ old('company_info') }}</textarea>
            @error('company_info')
                <p class="text-red-500">{{ $message }}</p>
            @enderror
        </div>
